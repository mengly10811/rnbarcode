...
class BarcodeViewManager : ViewGroupManager<CameraView>() {
  ...
  override fun getExportedCustomDirectEventTypeConstants(): MutableMap<String, Any>? {
    return MapBuilder.builder<String, Any>()
      ...
      .put("barcodeScaned", MapBuilder.of("registrationName", "onBarcodeScaned"))
      .build()
  }
  ...
  fun setCameraId(view: CameraView, cameraId: String) {
    ...
    Log.d(TAG,"cameraId to set： "+cameraId)
  ...
  fun setEnableFrameProcessor(view: CameraView, enableFrameProcessor: Boolean) {
    ...
    Log.d(TAG,"setEnableFrameProcessor to set： "+enableFrameProcessor)
  }
